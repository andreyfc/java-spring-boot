package br.andrey.spring.handler;

import br.andrey.spring.endpoint.error.ErrorDetails;
import br.andrey.spring.endpoint.error.ResourceNotFoundDetails;
import br.andrey.spring.endpoint.error.ResourceNotFoundException;
import br.andrey.spring.endpoint.error.ValidationErrorDetails;
